...
Det finns en totalfil var för publiceringsåren 2017 till 2020, samt ytterligare två filer för publiceringsår 2020 fördelat på lärosäten och forskningsämnen på 1-siffernivå enligt [Standard för svensk indelning av forskningsämnen](https://www.scb.se/dokumentation/klassifikationer-och-standarder/standard-for-svensk-indelning-av-forskningsamnen/).
